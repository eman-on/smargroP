...
Solution is to delete that layers manually or use program "Digitals Checker" from this repository to compare existing layers with qualifier and automatically delete unregistered. Button and Settings are integrated in GIS System.

Insert into "Digitals" folder
